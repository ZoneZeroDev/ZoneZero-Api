...
open class PlayersController {
    ...
    open fun loginPlayerStandard(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/login/ip")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun loginPlayerIp(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/register")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun registerPlayer(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/remove")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun removePlayer(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
        val response = ServiceUtils.post(request, Addresses.PLAYER, "remove")
        return ResponseFactory.create(request, HttpStatus.valueOf(response.code), response.body)
    }

    @Post("/changePassword")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun changePassword(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/2fa/enable")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun twoFaEnable(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/2fa/disable")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun twoFaDisable(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/2fa/code")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun twoFaCode(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
    ...
    @Post("/check")
    @Authentication(permissions = [AccountType.SERVER_100, AccountType.SERVER_500, AccountType.SERVER_1000])
    open fun checkPlayer(request: HttpRequest<String?>): HttpResponse<DataAnswer> {
